...
export const experiments: ExperimentItem[] = [
  ...
  {
    id: "codex-atmospherssssssssssssssssse",
    title: "Codex Atmosphere",
    description: "Warm video texture with a cursor-reactive ASCII field.",
    year: "2026",
    tags: ["Canvas", "Pointer", "Atmosphere"],
